...
public class QLearning {
    ...
    public static void main(String[] args) {
        ...
        y_dist = (activeGame.getPanel().getBall().getY() - activeGame.getPanel().getPlayer(1).getY());
        x_pos_balls = activeGame.getPanel().getBall().getX();
        y_pos_racket = activeGame.getPanel().getPlayer(1).getY();
        true_y_pos_racket = y_pos_racket + activeGame.getPanel().getPlayer(1).getBounds().height / 2;
